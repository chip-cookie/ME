...
from app.shared.dart_service import DartService
from app.shared.nps_service import NPSService
    ...
    def analyze_jd(self, session_id: int):
        ...
        try:
            ...
            try:
                ...
                if corp_name:
                    # DART
                    dart_info = self.dart_service.fetch_company_summary(corp_name)
                    financial_data['dart'] = dart_info
                        
                    # NPS
                    nps_info = self.nps_service.fetch_company_data(corp_name)
